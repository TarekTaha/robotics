...
*/
void EHMMObjDatabase::Load( const string &databaseName, const string &path )
{
	...
	char line[ MAX_LINE_WIDTH ];
        ...
        std::cout<<"\nDatabase Name is:"<<databaseName; fflush(stdout);
        std::cout<<"\nPath is:"<<path; fflush(stdout);
	assert( file.is_open( ) );
